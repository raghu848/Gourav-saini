...
export const aboutMetadata: Metadata = {
  ...
  description: 'Award-winning orthopaedic surgeon in Mohali with 20+ years\' experience, specialist in robotic hip & knee surgery, sports injuries, arthroscopy & trauma care.',
  keywords: 'orthopedic surgeon knee specialist, best orthopedic doctor in mohali',
  alternates: {
...
export const contactMetadata: Metadata = {
  ...
  description: 'Book an appointment with Dr Gaurav Saini, a trusted orthopaedic surgeon in Mohali & Chandigarh, for expert knee, hip, joint, and spine treatment.',
  keywords: 'orthopedic clinic in mohali',
  alternates: {
...
export const servicesMetadata: Metadata = {
  ...
  keywords: 'hip and knee clinic, orthopedic surgeon knee specialist',
  alternates: {
...
export const testimonialsMetadata: Metadata = {
  ...
  keywords: 'best orthopedic doctor in mohali reviews',
  alternates: {
...
export const blogMetadata: Metadata = {
  ...
  keywords: 'orthopedic health blog',
  alternates: {
    canonical: 'https://drgauravsainiortho.com/blog/'
  }
}

// Book Appointment page metadata
export const bookAppointmentMetadata: Metadata = {
  ...
  keywords: 'book orthopedic appointment',
  alternates: {
...
export const servicePagesMetadata = {
  // Robotic Joint Replacement
  'robotic-joint-replacement': {
    title: 'Best Robotic Knee Replacement in Mohali | Dr. Gaurav Saini',
    ...
    keywords: 'robotic knee replacement, orthopaedic surgeon, best orthopedic doctor in mohali',
    canonical: 'https://drgauravsainiortho.com/services/robotic-joint-replacement/'
  },
  
  // Sports Injury Arthroscopy
  'sports-injury-arthroscopy': {
    title: 'Trusted Sports Injury Doctor in Mohali | Dr. Gaurav Saini',
    description: 'Consult Dr. Gaurav Saini, a top sports injury doctor near me, for advanced arthroscopic knee surgery and expert orthopedic care in Mohali & Chandigarh.',
    keywords: 'sports injury doctor, orthopedic surgeon knee specialist',
    canonical: 'https://drgauravsainiortho.com/services/sports-injury-arthroscopy/'
  },
  
  // Fracture Trauma Care
  'fracture-trauma-care': {
    title: 'Bone Fracture Specialist | Dr. Gaurav Saini',
    description: 'Get expert care from Dr. Gaurav Saini, a trusted fracture doctor near me and bone fracture specialist in Mohali & Chandigarh. Book appointment today.',
    keywords: 'bone fracture specialist, orthopedic clinic in mohali',
    canonical: 'https://drgauravsainiortho.com/services/fracture-trauma-care/'
  },
  
  // Joint Replacement Center
  'joint-replacement-center': {
    title: 'Best Knee Replacement Surgeon in Chandigarh | Dr. Gaurav Saini',
    ...
    keywords: 'knee replacement surgeon, hip and knee clinic',
    canonical: 'https://drgauravsainiortho.com/services/joint-replacement-center/'
  },
  ...
  'robotic-surgery': {
    ...
    description: 'Experience world-class robotic knee replacement in Mohali with Dr. Gaurav Saini. Advanced, precise orthopaedic care for superior knee, hip, and joint health.',
    keywords: 'robotic knee replacement, orthopaedic surgeon, best orthopedic doctor in mohali',
    canonical: 'https://drgauravsainiortho.com/services/robotic-surgery/'
  },
  ...
  'hip-replacement-surgery': {
    ...
    description: 'Get trusted care with Dr. Gaurav Saini, the best knee replacement surgeon in Chandigarh. Advanced joint replacement & orthopedic care. Book today.',
    keywords: 'knee replacement surgeon, hip and knee clinic',
    canonical: 'https://drgauravsainiortho.com/services/hip-replacement-surgery/'
  },
  ...
  'knee-replacement-surgery': {
    ...
    description: 'Experience world-class robotic knee replacement in Mohali with Dr. Gaurav Saini. Advanced, precise orthopaedic care for superior knee, hip, and joint health.',
    keywords: 'robotic knee replacement, orthopaedic surgeon, best orthopedic doctor in mohali',
    canonical: 'https://drgauravsainiortho.com/services/knee-replacement-surgery/'
  },
  ...
  'sports-injury-treatment': {
    ...
    description: 'Consult Dr. Gaurav Saini, a top sports injury doctor near me, for advanced arthroscopic knee surgery and expert orthopedic care in Mohali & Chandigarh.',
    keywords: 'sports injury doctor, orthopedic surgeon knee specialist',
    canonical: 'https://drgauravsainiortho.com/services/sports-injury-treatment/'
  },
  ...
  'arthroscopic-surgery': {
    ...
    description: 'Consult Dr. Gaurav Saini, a top sports injury doctor near me, for advanced arthroscopic knee surgery and expert orthopedic care in Mohali & Chandigarh.',
    keywords: 'sports injury doctor, orthopedic surgeon knee specialist',
    canonical: 'https://drgauravsainiortho.com/services/arthroscopic-surgery/'
  },
  ...
  'spine-surgery': {
    ...
    description: 'Get expert care from Dr. Gaurav Saini, a trusted fracture doctor near me and bone fracture specialist in Mohali & Chandigarh. Book appointment today.',
    keywords: 'bone fracture specialist, orthopedic clinic in mohali',
    canonical: 'https://drgauravsainiortho.com/services/spine-surgery/'
  }
}

export const generateServiceMetadata = (service: string): Metadata => {
  const serviceData = servicePagesMetadata[service as keyof typeof servicePagesMetadata]
  if (!serviceData) {
    return {
