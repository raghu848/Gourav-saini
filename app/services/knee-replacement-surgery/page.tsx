    ...
    <div className="min-h-screen bg-gray-50 py-12 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav className="mb-8 text-sm">
          ...
          <span className="ml-2 text-gray-500">Knee Replacement Surgery</span>
        </nav>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Advanced knee replacement solutions for pain relief and restored mobility using robotic assistance
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6 font-serif">
                Restoring Mobility with Advanced Knee Replacement
              </h2>
              <p className="text-gray-700 mb-6">
                Our knee replacement surgery program combines cutting-edge technology with expert surgical skills to provide lasting relief from knee pain.
              </p>
              <p className="text-gray-700 mb-6">
                Using the latest robotic-assisted techniques, we ensure precise implant placement for optimal function and longevity.
              </p>
              
              <div className="bg-blue-50 p-6 rounded-lg mb-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Knee Conditions We Treat:</h3>
          ...
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center font-serif">
              Advanced Knee Replacement Services
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900">Robotic-Assisted Knee Replacement</h3>
                </div>
                <p className="text-gray-600 mb-4">
                  Using CORI robotic technology for precise implant placement and optimal alignment.
                </p>
          ...
          <div className="bg-gradient-to-r from-blue-900 to-green-900 text-white rounded-2xl p-4 lg:p-6 mb-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
              <div>
                <h2 className="text-3xl font-bold font-serif mb-4">Why Choose Our Knee Replacement?</h2>
                <p className="text-blue-100 mb-4">
                  Our comprehensive knee replacement program combines advanced technology with expert care for optimal outcomes.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-center">
                    <CheckCircle className="w-5 h-5 text-green-300 mr-3" />
                    <span>Robotic-assisted precision</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="w-5 h-5 text-green-300 mr-3" />
              ...
              <div className="bg-white bg-opacity-10 rounded-xl p-2">
                ...
                <div className="rounded-lg overflow-hidden border border-blue-200">
                  <Image 
                    ...
                    alt="Dr. Gaurav Saini performing knee replacement surgery" 
                    width={500}
                    height={300}
                ...
                <h3 className="text-xl font-semibold mb-1">Knee Replacement Statistics</h3>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              For knee replacement surgery consultation, contact our specialists to discuss your treatment options.
            </p>
